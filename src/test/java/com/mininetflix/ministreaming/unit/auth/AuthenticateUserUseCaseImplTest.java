...
class AuthenticateUserUseCaseImplTest {
  ...
  void shouldAuthenticateSuccessfully() {
    ...
    AuthenticateUserInput input = new AuthenticateUserInput("luis@email.com", "123456");
  ...
  void shouldThrowExceptionWhenUserDoesNotExist() {
    ...
    AuthenticateUserInput input = new AuthenticateUserInput("unknown@email.com", "123456");
  ...
  void shouldThrowExceptionWhenPasswordIsInvalid() {
    ...
    User user = new User("Luis", "luis@email.com", "hashed-password");

    AuthenticateUserInput input = new AuthenticateUserInput("luis@email.com", "wrong-password");

    Mockito.when(userRepository.findByEmail(input.email())).thenReturn(Optional.of(user));
