...
public class GetVideoStatisticsUseCaseImpl implements GetVideoStatisticsUseCase {

  private final VideoStatisticsRepository repository;

  @Override
  public VideoStatisticsResponse execute(String videoId) {

    VideoStatistics statistics = repository.findByVideoId(videoId).orElseThrow();
