...
public class GetContinueWatchingUseCaseImpl
                implements GetContinueWatchingUseCase {
        ...
        public List<ContinueWatchingItem> execute(String userId) {
                ...
                return playbackRepository
                                ...
                                .map(playback -> {
                                        ...
                                        String thumbnailUrl = storageService.generatePublicUrl(
                                                        video.getThumbnailKey());

                                        int progress = (int) ((playback.getCurrentTime()
                                                        / video.getDuration()) * 100);
