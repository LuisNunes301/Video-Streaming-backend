...
public class MinioVideoStorageService implements VideoStorageService {
  ...
  public void upload(String objectKey, MultipartFile file) {
    ...
    storageService.upload(StorageBucketEnum.VIDEOS, objectKey, file);
  }

  @Override
  public File download(String objectKey) {

    return storageService.download(StorageBucketEnum.VIDEOS, objectKey);
  }

  @Override
  public void uploadFile(String objectKey, File file) {

    storageService.uploadFile(StorageBucketEnum.VIDEOS, objectKey, file);
  }

  @Override
  public String generatePublicUrl(String objectKey) {

    return storageService.generatePublicUrl(StorageBucketEnum.VIDEOS, objectKey);
  }
}
