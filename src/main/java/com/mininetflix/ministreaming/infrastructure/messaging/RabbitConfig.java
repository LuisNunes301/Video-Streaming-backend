...
public class RabbitConfig {
  ...
  public Queue videoUploadedQueue() {
    ...
    return QueueBuilder.durable(VIDEO_UPLOADED_QUEUE).build();
  }

  @Bean
  public Queue videoCompletedQueue() {

    return QueueBuilder.durable(VIDEO_COMPLETED_QUEUE).build();
  }

  @Bean
  public Binding bindingVideoUploaded(Queue videoUploadedQueue, TopicExchange videoExchange) {
  ...
  @Bean
  public Binding bindingVideoCompleted(Queue videoCompletedQueue, TopicExchange videoExchange) {
