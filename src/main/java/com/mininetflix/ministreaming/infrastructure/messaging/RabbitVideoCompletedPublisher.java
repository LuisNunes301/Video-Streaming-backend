...
public class RabbitVideoCompletedPublisher implements VideoCompletedPublisher {
  ...
  public void publish(VideoCompletedEvent event) {
    ...
    System.out.println("PUBLICANDO EVENTO VIDEO COMPLETED -> " + event.videoId());

    rabbitTemplate.convertAndSend(
        RabbitConfig.VIDEO_EXCHANGE, RabbitConfig.VIDEO_COMPLETED_ROUTING_KEY, event);
  }
}
